...
import { CardTypeOrderComponent } from '@components/card-type-order/card-type-order.component';
...
@Component({
  ...
  imports: [
    ...
    RouterOutlet,
    BreadcrumbComponent,
    CardTypeOrderComponent,
    OrderListComponent,
    ButtonModule,
  ],
  templateUrl: './claro-orders.component.html',
  styleUrl: './claro-orders.component.scss',
})
export default class ClaroOrdersComponent {
  ...
  #stateClaroTypeOrder = signal<StateTypeOrder[]>([
  ...
  claroTypeOrder = computed( () => this.#stateClaroTypeOrder())
